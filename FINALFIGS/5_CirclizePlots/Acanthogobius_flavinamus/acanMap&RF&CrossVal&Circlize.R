...
meta <- as.data.frame(read_xlsx("Hirase2017_Table1.xlsx",sheet = 1))
...
dat <- as.data.frame(read_xlsx('Hirase2017_Fig2.xlsx',sheet=1))
...
save(native,file="acanForRangerCrossValidation.rda")

### ran on "XXXXCrossvalidation_forServer.R" separately 
load(file="acan_Ranger_out.rda")
...
write.csv(n,"acan_sampleSize.csv",quote=F)
