...
dat <- as.data.frame(read_xlsx('Miura2006haplotypes_haps.xlsx',sheet=2))
...
save(native,file="Cercaria_HL1ForRangerCrossValidation.rda")

### ran on "XXXXCrossvalidation_forServer.R" separately 
load(file="Cercaria_HL1_Ranger_out.rda")
...
write.csv(mat,"Cercaria_HL1ByReg.csv")
...
write.csv(n,"Cercaria_HL1_sampleSize.csv",quote=F)
