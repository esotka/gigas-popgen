...
dat <- as.data.frame(read_xlsx('Miura2006haplotypes_haps.xlsx',sheet=3))
...
save(native,file="Cercaria_HL6ForRangerCrossValidation.rda")

### ran on "XXXXCrossvalidation_forServer.R" separately 
load(file="Cercaria_HL6_Ranger_out.rda")
...
write.csv(mat,"Cercaria_HL6ByReg.csv")
...
write.csv(n,"Cercaria_HL6_sampleSize.csv",quote=F)
