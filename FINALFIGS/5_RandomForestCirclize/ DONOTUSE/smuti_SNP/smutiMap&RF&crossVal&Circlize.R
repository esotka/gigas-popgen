...
pdf("FINALFIGS/5_RandomForestCirclize/smuti/map.pdf",height=6,width=5); map1(); dev.off()
...
write.csv(n,"FINALFIGS/5_RandomForestCirclize/ALLSPECIES/smuti_sampleSize.csv",quote=F)
