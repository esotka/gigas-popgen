...
pdf("FINALFIGS/5_RandomForestCirclize/ALLSPECIES/RandomForestPieCharts+Shipping.pdf",width=6,height=12)
par(mfrow=c(12,5),mar=c(0,0,0,1))
...
pie(tbl[,c("bay_biscay")],col = col.to.use,labels = "",main="Europe_south") #EuropeSouth
pie(tbl[,c("NZ")],col = col.to.use,labels = "",main="NZ") #NZ
