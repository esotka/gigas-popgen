...
pdf("FINALFIGS/5_RandomForestCirclize/rudi/map.pdf",height=6,width=5); map1(); dev.off()
...
write.csv(n,"FINALFIGS/5_RandomForestCirclize/ALLSPECIES/rudi_sampleSize.csv",quote=F)
